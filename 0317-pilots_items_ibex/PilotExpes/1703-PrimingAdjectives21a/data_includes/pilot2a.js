var shuffleSequence = seq("00", "instr1", "practice", rshuffle(startsWith("2")), "instr2", rshuffle(startsWith("a")), "form",  "sr","code");
...
var items = [
    ...
    ['instr2',"NewMessage", {html: {include: 'instructions2_2a.html'}}],
