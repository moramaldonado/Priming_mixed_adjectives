var shuffleSequence = seq("00", "instr", "practice", rshuffle(startsWith("b")), "instr2", rshuffle(startsWith("2")), "form",  "sr","code");
...
var items = [
    ...
    ['instr',"NewMessage", {html: {include: 'instructions_part1.html'}}],
    ['practice','PictureAccept',{s:'The bags are heavy.',as:[['D', 'http://mmaldonado.psycholinguae.fr/img/bags_0.png'], ['K', 'http://mmaldonado.psycholinguae.fr/img/hidden-bags.png']]}],
